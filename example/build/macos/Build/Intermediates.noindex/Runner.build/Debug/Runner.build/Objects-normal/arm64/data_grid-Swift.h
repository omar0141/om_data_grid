...
#ifndef DATA_GRID_SWIFT_H
#define DATA_GRID_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="data_grid",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC9data_grid11AppDelegate")
...
SWIFT_CLASS("_TtC9data_grid17MainFlutterWindow")
