...
class GridSubstringHighlight extends StatelessWidget {
  const GridSubstringHighlight({
    super.key,
    ...
    this.textStyleHighlight = const TextStyle(color: Colors.amber),
      ...
      if (iNearest >= 0) {
        ...
        children.add(
          TextSpan(
            ...
            style: textStyleHighlight.copyWith(backgroundColor: Colors.amber),
          ),
        );
